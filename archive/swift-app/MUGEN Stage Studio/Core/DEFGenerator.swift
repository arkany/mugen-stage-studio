...
class DEFGenerator {
    ...
    /// Uses fixed 1280x720 settings matching known working stages
    static func generate(from document: StageDocument) -> String {
        var lines: [String] = []
        
        // Header comment
        lines.append("; Generated by MUGEN Stage Studio")
        lines.append("; Fixed 1280x720 format for IKEMEN GO compatibility")
        lines.append("")
        ...
        // [Camera] section - Fixed values from working stage
        lines.append("[Camera]")
        lines.append("startx = 0")
        lines.append("starty = 0")
        lines.append("boundleft = -500")
        lines.append("boundright = 500")
        lines.append("boundhigh = -25")
